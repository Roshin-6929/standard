            ...
            <section className="flat-product-detail style1">
              <div className="container">
                <div className="row boxrow">
                        ...
                        {!(data?.images?.length) ?
                          ...
                          <>
                            ...
                            <Swiper
                              ...
                              className="mySwiper"
                            >{
                                data?.images?.map(img => (<SwiperSlide>
                                  <img
                  ...
                  <div className="col-md-6 col-12 productdetail">
                    <div className="product-detail style1">
                      <span className="bg"></span>
                      <div className="header-detail">
                        <h4 style={{ fontSize: "1.8rem" }} className="name">{data?.title}</h4>
            ...
            <div className="row pb-5">
              ...
              <div className="col-md-8 pl-5">
                <div className="tecnical-specs">
                  ...
                  <table>
                    <tbody>
                      {data?.product_features?.map((ft) => (<tr>
                        <td>{ft.name}</td>
