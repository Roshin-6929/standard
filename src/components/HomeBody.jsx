  ...
  return (
    <>
      ...
      <section className="container">
        <div className="row">
          <div className="col-md-3 row feat">
          ...
          <div className="col-md-3 row feat feat-last">
            <div className="col-md-3">
            ...
            <div className="col-md-12">
              <div className="product-wrap">
                <div className="product-tab style1">
                  <ul className="tab-list">
                    {data.categories?.slice(3).map(c => (<li onClick={() => setCat(c)} className={c.id === cat?.id ? "active" : ""}>{c.title}</li>))}
                  </ul>
                </div>
      ...
      <section className="container mt-5 pb-5">
        <div className="row">
          <div className="col-md-12">
            <img style={{ width: "100%" }} src="/images/Group 46.png" />
          </div>
        </div>
      </section>
